...
calculate_rmse(y_test,reg_model_predictions)
r2_score(y_test, reg_model_predictions)
...
#pickle file
save_path = '../assets/trained-models/load_shortfall_base_lm_regression.pkl'
print (f"Training completed. Saving model to: {save_path}")
pickle.dump(reg_model, open(save_path,'wb'))
